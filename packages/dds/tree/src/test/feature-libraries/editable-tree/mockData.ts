...
export const addressSchema = namedTreeSchema({
    ...
    localFields: {
        // TODO: semantically it would be correct to make it of kind `value`, but how then one could set its type in runtime?
...
export type Address = EditableTree &
    Brand<
        {
            // TODO: semantically it would be correct to make `zip` mandatory, but how then one could set its type in runtime?
            zip?: String | Int32;
            street?: String;
            city?: String;
            country?: String;
