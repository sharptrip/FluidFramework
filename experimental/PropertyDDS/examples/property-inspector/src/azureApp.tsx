...
import { brand, ISharedTree, SharedTreeFactory, singleTextCursor } from "@fluid-internal/tree";
...
import { personData, personSchemaName } from "./demoPersonData";
...
async function start(): Promise<void> {
    ...
    const schema = convertPSetSchema(new Set([personSchemaName]), brand("Optional"));
