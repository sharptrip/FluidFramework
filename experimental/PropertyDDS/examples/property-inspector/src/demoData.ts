...
export const personPropertyDDSSchemas = {
	...
	foo: {
		typeid: "Test:Foo-1.0.0",
		properties: [{ id: "bar", typeid: "Test:Foo-1.0.0", optional: true }],
	},
	phone: {
	...
	person: {
		...
		properties: [
			...
			{ id: "foo", typeid: "Test:Foo-1.0.0", optional: true },
		],
	},
};
...
export type Friends = EditableTree &
	Brand<Record<FieldKey, string>, "editable-tree-inspector-demo.Map<string>">;
