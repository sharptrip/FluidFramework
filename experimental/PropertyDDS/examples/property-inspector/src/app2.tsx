...
import { convertPropertyToSharedTreeSchema as convertPSetSchema } from "@fluid-experimental/property-shared-tree-interop";

import { renderApp } from "./editableTreeInspector";
import { personPropertyDDSSchemas, personSchemaName } from "./demoData";
...
export async function start(): Promise<void> {
	...
	const fullSchemaData = convertPSetSchema(optional, new Set([personSchemaName]));
