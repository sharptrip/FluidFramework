...
export interface INewDataFormProps {
   ...
   */
  onDataCreate: (rowData: IInspectorRow | EditableTreeRow, name: string, typeid: string, context: string) => void;
  /**
...
const getSiblingIDs = (rowData: EditableTreeRow | IInspectorRow): string[] => {
