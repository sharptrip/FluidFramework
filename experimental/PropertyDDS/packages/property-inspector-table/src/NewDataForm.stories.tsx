...
import { EditableTreeRow, IInspectorRow } from './InspectorTableTypes';
    ...
    return (
      <div style={{border: '1px solid rgba(1,1,1,0)', width: '400px', fontFamily: 'sans-serif'}}>
          <NewDataForm
            ...
            onDataCreate={(rowData: IInspectorRow | EditableTreeRow, name: string, typeid: string, context: string) =>
              alert(
