...
import {
  ...
  IInspectorSearchMatch, IInspectorSearchMatchMap,
  IInspectorSearchState, IToTableRowsOptions, IToTableRowsProps,
}
...
export const search = (
  ...
  chunkSize = 1000, recursive = false, entryPoint = true, fillExpanded: any): IInspectorSearchControls => {
